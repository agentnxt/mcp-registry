...
export function registerManagementTools(server, getClient) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    }, async ({ userId, isSuspended }) => (await getClient()).patch(`/users/${userId}/is-suspended`, { isSuspended }).then((r) => r.data));
    ...
    }, async ({ userId, password }) => (await getClient()).patch(`/users/${userId}/password`, { password }).then((r) => r.data));
    tool("verify_user_password", "Verify a user's current password", {
        type: "object", required: ["userId", "password"],
        properties: { userId: { type: "string" }, password: { type: "string" } },
    }, async ({ userId, password }) => (await getClient()).post(`/users/${userId}/password/verify`, { password }).then((r) => r.data));
    ...
    }, async ({ userId, ...q }) => (await getClient()).get(`/users/${userId}/roles${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ userId, roleIds }) => (await getClient()).post(`/users/${userId}/roles`, { roleIds }).then((r) => r.data));
    ...
    }, async ({ userId, roleIds }) => (await getClient()).put(`/users/${userId}/roles`, { roleIds }).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/users/${a.userId}/roles/${a.roleId}`).then((r) => r.data));
    tool("get_user_identities", "Get a user's social identities", {
        type: "object", required: ["userId"],
        properties: { userId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/users/${a.userId}/identities`).then((r) => r.data));
    ...
    }, async ({ userId, target, ...body }) => (await getClient()).put(`/users/${userId}/identities/${target}`, body).then((r) => r.data));
    tool("delete_user_identity", "Delete a user's social identity", {
        type: "object", required: ["userId", "target"],
        properties: { userId: { type: "string" }, target: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/users/${a.userId}/identities/${a.target}`).then((r) => r.data));
    ...
    }, async ({ userId, ...q }) => (await getClient()).get(`/users/${userId}/organizations${buildQuery(q)}`).then((r) => r.data));
    tool("get_user_mfa_verifications", "Get a user's MFA verifications", {
        type: "object", required: ["userId"],
        properties: { userId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/users/${a.userId}/mfa-verifications`).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/users/${a.userId}/mfa-verifications/${a.verificationId}`).then((r) => r.data));
    ...
    }, async ({ userId, ...q }) => (await getClient()).get(`/users/${userId}/logs${buildQuery(q)}`).then((r) => r.data));
    tool("get_user_custom_data", "Get a user's custom data", {
        type: "object", required: ["userId"],
        properties: { userId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/users/${a.userId}/custom-data`).then((r) => r.data));
    ...
    }, async ({ userId, customData }) => (await getClient()).patch(`/users/${userId}/custom-data`, { customData }).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // APPLICATIONS
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/applications/${a.applicationId}`).then((r) => r.data));
    ...
    }, async ({ applicationId, ...body }) => (await getClient()).patch(`/applications/${applicationId}`, body).then((r) => r.data));
    tool("delete_application", "Delete an application", {
        type: "object", required: ["applicationId"],
        properties: { applicationId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/applications/${a.applicationId}`).then((r) => r.data));
    tool("list_application_secrets", "List secrets for an application", {
        type: "object", required: ["applicationId"],
        properties: { applicationId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/applications/${a.applicationId}/secrets`).then((r) => r.data));
    ...
    }, async ({ applicationId, ...body }) => (await getClient()).post(`/applications/${applicationId}/secrets`, body).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/applications/${a.applicationId}/secrets/${a.secretName}`).then((r) => r.data));
    ...
    }, async ({ applicationId, secretName, ...body }) => (await getClient()).patch(`/applications/${applicationId}/secrets/${secretName}`, body).then((r) => r.data));
    ...
    }, async ({ applicationId, ...q }) => (await getClient()).get(`/applications/${applicationId}/roles${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ applicationId, roleIds }) => (await getClient()).post(`/applications/${applicationId}/roles`, { roleIds }).then((r) => r.data));
    ...
    }, async ({ applicationId, roleIds }) => (await getClient()).put(`/applications/${applicationId}/roles`, { roleIds }).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/applications/${a.applicationId}/roles/${a.roleId}`).then((r) => r.data));
    tool("list_application_consent_scopes", "List user consent scopes of an application", {
        type: "object", required: ["applicationId"],
        properties: { applicationId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/applications/${a.applicationId}/user-consent-scopes`).then((r) => r.data));
    tool("get_application_sign_in_experience", "Get app-level sign-in experience", {
        type: "object", required: ["applicationId"],
        properties: { applicationId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/applications/${a.applicationId}/sign-in-experience`).then((r) => r.data));
    ...
    }, async ({ applicationId, ...body }) => (await getClient()).put(`/applications/${applicationId}/sign-in-experience`, body).then((r) => r.data));
    tool("list_application_custom_domains", "List custom domains for a protected app", {
        type: "object", required: ["applicationId"],
        properties: { applicationId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/applications/${a.applicationId}/protected-app-metadata/custom-domains`).then((r) => r.data));
    ...
    }, async ({ applicationId, domain }) => (await getClient()).post(`/applications/${applicationId}/protected-app-metadata/custom-domains`, { domain }).then((r) => r.data));
    tool("delete_application_custom_domain", "Remove a custom domain from a protected app", {
        type: "object", required: ["applicationId", "domain"],
        properties: { applicationId: { type: "string" }, domain: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/applications/${a.applicationId}/protected-app-metadata/custom-domains/${a.domain}`).then((r) => r.data));
    ...
    }, async ({ applicationId, ...q }) => (await getClient()).get(`/applications/${applicationId}/organizations${buildQuery(q)}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // ORGANIZATIONS
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/organizations/${a.organizationId}`).then((r) => r.data));
    ...
    }, async ({ organizationId, ...body }) => (await getClient()).patch(`/organizations/${organizationId}`, body).then((r) => r.data));
    tool("delete_organization", "Delete an organization", {
        type: "object", required: ["organizationId"],
        properties: { organizationId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/organizations/${a.organizationId}`).then((r) => r.data));
    ...
    }, async ({ organizationId, ...q }) => (await getClient()).get(`/organizations/${organizationId}/users${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ organizationId, userIds }) => (await getClient()).post(`/organizations/${organizationId}/users`, { userIds }).then((r) => r.data));
    ...
    }, async ({ organizationId, userIds }) => (await getClient()).put(`/organizations/${organizationId}/users`, { userIds }).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/organizations/${a.organizationId}/users/${a.userId}`).then((r) => r.data));
    tool("get_organization_user_roles", "Get roles for a user in an organization", {
        type: "object", required: ["organizationId", "userId"],
        properties: { organizationId: { type: "string" }, userId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/organizations/${a.organizationId}/users/${a.userId}/roles`).then((r) => r.data));
    ...
    }, async ({ organizationId, userId, organizationRoleIds }) => (await getClient()).post(`/organizations/${organizationId}/users/${userId}/roles`, { organizationRoleIds }).then((r) => r.data));
    ...
    }, async ({ organizationId, userId, organizationRoleIds }) => (await getClient()).put(`/organizations/${organizationId}/users/${userId}/roles`, { organizationRoleIds }).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/organizations/${a.organizationId}/users/${a.userId}/roles/${a.organizationRoleId}`).then((r) => r.data));
    tool("get_organization_user_scopes", "Get scopes for a user in an organization", {
        type: "object", required: ["organizationId", "userId"],
        properties: { organizationId: { type: "string" }, userId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/organizations/${a.organizationId}/users/${a.userId}/scopes`).then((r) => r.data));
    ...
    }, async ({ organizationId, ...q }) => (await getClient()).get(`/organizations/${organizationId}/applications${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ organizationId, applicationIds }) => (await getClient()).post(`/organizations/${organizationId}/applications`, { applicationIds }).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/organizations/${a.organizationId}/applications/${a.applicationId}`).then((r) => r.data));
    tool("get_organization_application_roles", "Get roles for an application in an organization", {
        type: "object", required: ["organizationId", "applicationId"],
        properties: { organizationId: { type: "string" }, applicationId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/organizations/${a.organizationId}/applications/${a.applicationId}/roles`).then((r) => r.data));
    ...
    }, async ({ organizationId, applicationId, organizationRoleIds }) => (await getClient()).post(`/organizations/${organizationId}/applications/${applicationId}/roles`, { organizationRoleIds }).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // ORGANIZATION ROLES
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/organization-roles/${a.organizationRoleId}`).then((r) => r.data));
    ...
    }, async ({ organizationRoleId, ...body }) => (await getClient()).patch(`/organization-roles/${organizationRoleId}`, body).then((r) => r.data));
    tool("delete_organization_role", "Delete an organization role", {
        type: "object", required: ["organizationRoleId"],
        properties: { organizationRoleId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/organization-roles/${a.organizationRoleId}`).then((r) => r.data));
    ...
    }, async ({ organizationRoleId, ...q }) => (await getClient()).get(`/organization-roles/${organizationRoleId}/scopes${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ organizationRoleId, organizationScopeIds }) => (await getClient()).post(`/organization-roles/${organizationRoleId}/scopes`, { organizationScopeIds }).then((r) => r.data));
    ...
    }, async ({ organizationRoleId, organizationScopeIds }) => (await getClient()).put(`/organization-roles/${organizationRoleId}/scopes`, { organizationScopeIds }).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/organization-roles/${a.organizationRoleId}/scopes/${a.organizationScopeId}`).then((r) => r.data));
    tool("list_organization_role_resource_scopes", "List resource scopes for an org role", {
        type: "object", required: ["organizationRoleId"],
        properties: { organizationRoleId: { type: "string" }, page: { type: "number" }, page_size: { type: "number" } },
    }, async ({ organizationRoleId, ...q }) => (await getClient()).get(`/organization-roles/${organizationRoleId}/resource-scopes${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ organizationRoleId, scopeIds }) => (await getClient()).post(`/organization-roles/${organizationRoleId}/resource-scopes`, { scopeIds }).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // ORGANIZATION SCOPES
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/organization-scopes/${a.organizationScopeId}`).then((r) => r.data));
    ...
    }, async ({ organizationScopeId, ...body }) => (await getClient()).patch(`/organization-scopes/${organizationScopeId}`, body).then((r) => r.data));
    tool("delete_organization_scope", "Delete an organization scope", {
        type: "object", required: ["organizationScopeId"],
        properties: { organizationScopeId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/organization-scopes/${a.organizationScopeId}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/organization-invitations/${a.invitationId}`).then((r) => r.data));
    tool("delete_organization_invitation", "Delete an organization invitation", {
        type: "object", required: ["invitationId"],
        properties: { invitationId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/organization-invitations/${a.invitationId}`).then((r) => r.data));
    ...
    }, async ({ invitationId, status }) => (await getClient()).put(`/organization-invitations/${invitationId}/status`, { status }).then((r) => r.data));
    tool("resend_organization_invitation", "Resend an organization invitation email", {
        type: "object", required: ["invitationId"],
        properties: { invitationId: { type: "string" } },
    }, async (a) => (await getClient()).post(`/organization-invitations/${a.invitationId}/message`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // ROLES
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async ({ roleId, ...body }) => (await getClient()).patch(`/roles/${roleId}`, body).then((r) => r.data));
    ...
    }, async ({ roleId, ...q }) => (await getClient()).get(`/roles/${roleId}/scopes${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ roleId, scopeIds }) => (await getClient()).post(`/roles/${roleId}/scopes`, { scopeIds }).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/roles/${a.roleId}/scopes/${a.scopeId}`).then((r) => r.data));
    tool("get_role_users", "Get users assigned to a role", {
        type: "object", required: ["roleId"],
        properties: { roleId: { type: "string" }, page: { type: "number" }, page_size: { type: "number" } },
    }, async ({ roleId, ...q }) => (await getClient()).get(`/roles/${roleId}/users${buildQuery(q)}`).then((r) => r.data));
    tool("get_role_applications", "Get M2M applications assigned to a role", {
        type: "object", required: ["roleId"],
        properties: { roleId: { type: "string" }, page: { type: "number" }, page_size: { type: "number" } },
    }, async ({ roleId, ...q }) => (await getClient()).get(`/roles/${roleId}/applications${buildQuery(q)}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // API RESOURCES
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async ({ resourceId, ...body }) => (await getClient()).patch(`/resources/${resourceId}`, body).then((r) => r.data));
    tool("delete_resource", "Delete an API resource", {
        type: "object", required: ["resourceId"],
        properties: { resourceId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/resources/${a.resourceId}`).then((r) => r.data));
    ...
    }, async ({ resourceId, ...q }) => (await getClient()).get(`/resources/${resourceId}/scopes${buildQuery(q)}`).then((r) => r.data));
    ...
    }, async ({ resourceId, ...body }) => (await getClient()).post(`/resources/${resourceId}/scopes`, body).then((r) => r.data));
    ...
    }, async ({ resourceId, scopeId, ...body }) => (await getClient()).patch(`/resources/${resourceId}/scopes/${scopeId}`, body).then((r) => r.data));
    tool("delete_resource_scope", "Delete a scope from an API resource", {
        type: "object", required: ["resourceId", "scopeId"],
        properties: { resourceId: { type: "string" }, scopeId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/resources/${a.resourceId}/scopes/${a.scopeId}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // CONNECTORS
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/connectors/${a.connectorId}`).then((r) => r.data));
    ...
    }, async ({ connectorId, ...body }) => (await getClient()).patch(`/connectors/${connectorId}`, body).then((r) => r.data));
    tool("delete_connector", "Delete a connector", {
        type: "object", required: ["connectorId"],
        properties: { connectorId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/connectors/${a.connectorId}`).then((r) => r.data));
    ...
    }, async ({ connectorId, ...body }) => (await getClient()).post(`/connectors/${connectorId}/test`, body).then((r) => r.data));
    tool("list_connector_factories", "List all connector factories", {
        type: "object",
        properties: { keyword: { type: "string" }, type: { type: "string" } },
    }, async (a) => (await getClient()).get(`/connector-factories${buildQuery(a)}`).then((r) => r.data));
    tool("get_connector_factory", "Get a connector factory by ID", {
        type: "object", required: ["factoryId"],
        properties: { factoryId: { type: "string" } },
    }, async (a) => (await getClient()).get(`/connector-factories/${a.factoryId}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // WEBHOOKS (HOOKS)
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async ({ hookId, ...body }) => (await getClient()).patch(`/hooks/${hookId}`, body).then((r) => r.data));
    ...
    }, async ({ hookId, ...body }) => (await getClient()).post(`/hooks/${hookId}/test`, body).then((r) => r.data));
    ...
    }, async ({ hookId, ...q }) => (await getClient()).get(`/hooks/${hookId}/recent-logs${buildQuery(q)}`).then((r) => r.data));
    tool("update_hook_signing_key", "Regenerate the signing key for a webhook", {
        type: "object", required: ["hookId"],
        properties: { hookId: { type: "string" } },
    }, async (a) => (await getClient()).patch(`/hooks/${a.hookId}/signing-key`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // SIGN-IN EXPERIENCE
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/configs/oidc/${a.keyType}`).then((r) => r.data));
    ...
    }, async ({ keyType, ...body }) => (await getClient()).post(`/configs/oidc/${keyType}/rotate`, body).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).delete(`/configs/oidc/${a.keyType}/${a.keyId}`).then((r) => r.data));
    ...
    }, async (a) => (await getClient()).get(`/configs/jwt-customizer/${a.tokenTypePath}`).then((r) => r.data));
    ...
    }, async ({ tokenTypePath, ...body }) => (await getClient()).put(`/configs/jwt-customizer/${tokenTypePath}`, body).then((r) => r.data));
    tool("delete_jwt_customizer", "Delete a JWT customizer", {
        type: "object", required: ["tokenTypePath"],
        properties: { tokenTypePath: { type: "string", enum: ["access-token", "client-credentials"] } },
    }, async (a) => (await getClient()).delete(`/configs/jwt-customizer/${a.tokenTypePath}`).then((r) => r.data));
    ...
    }, async ({ tokenTypePath, ...body }) => (await getClient()).post(`/configs/jwt-customizer/${tokenTypePath}/test`, body).then((r) => r.data));
    ...
    tool("delete_domain", "Delete a custom domain", {
        type: "object", required: ["domainId"],
        properties: { domainId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/domains/${a.domainId}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // DASHBOARD
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/custom-phrases/${a.languageTag}`).then((r) => r.data));
    ...
    }, async ({ languageTag, translation }) => (await getClient()).put(`/custom-phrases/${languageTag}`, translation).then((r) => r.data));
    tool("delete_custom_phrase", "Delete custom phrases for a language", {
        type: "object", required: ["languageTag"],
        properties: { languageTag: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/custom-phrases/${a.languageTag}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/custom-profile-fields/${a.fieldName}`).then((r) => r.data));
    ...
    }, async ({ fieldName, ...body }) => (await getClient()).put(`/custom-profile-fields/${fieldName}`, body).then((r) => r.data));
    tool("delete_custom_profile_field", "Delete a custom profile field", {
        type: "object", required: ["fieldName"],
        properties: { fieldName: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/custom-profile-fields/${a.fieldName}`).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // ONE-TIME TOKENS
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/one-time-tokens/${a.tokenId}`).then((r) => r.data));
    tool("delete_one_time_token", "Delete a one-time token", {
        type: "object", required: ["tokenId"],
        properties: { tokenId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/one-time-tokens/${a.tokenId}`).then((r) => r.data));
    ...
    }, async ({ tokenId, status }) => (await getClient()).put(`/one-time-tokens/${tokenId}/status`, { status }).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // EMAIL TEMPLATES
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/email-templates/${a.templateId}`).then((r) => r.data));
    ...
    }, async ({ templateId, ...body }) => (await getClient()).patch(`/email-templates/${templateId}`, body).then((r) => r.data));
    tool("delete_email_template", "Delete an email template", {
        type: "object", required: ["templateId"],
        properties: { templateId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/email-templates/${a.templateId}`).then((r) => r.data));
    ...
    }, async ({ templates }) => (await getClient()).put("/email-templates", templates).then((r) => r.data));
    // ═══════════════════════════════════════════════════════════════
    // CAPTCHA PROVIDER
    // ═══════════════════════════════════════════════════════════════
    ...
    }, async (a) => (await getClient()).get(`/sso-connectors/${a.ssoConnectorId}`).then((r) => r.data));
    ...
    }, async ({ ssoConnectorId, ...body }) => (await getClient()).patch(`/sso-connectors/${ssoConnectorId}`, body).then((r) => r.data));
    tool("delete_sso_connector", "Delete an enterprise SSO connector", {
        type: "object", required: ["ssoConnectorId"],
        properties: { ssoConnectorId: { type: "string" } },
    }, async (a) => (await getClient()).delete(`/sso-connectors/${a.ssoConnectorId}`).then((r) => r.data));
